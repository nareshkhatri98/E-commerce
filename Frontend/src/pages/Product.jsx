    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500 '>
           <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo reprehenderit architecto iste itaque consequatur repellendus consectetur. Quasi harum voluptates exercitationem voluptate reprehenderit commodi eligendi laudantium odio, pariatur assumenda nostrum dolore?</p>
           <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo reprehenderit architecto iste itaque consequatur repellendus consectetur. Quasi harum voluptates exercitationem voluptate reprehenderit commodi eligendi laudantium odio, pariatur assumenda nostrum dolore?</p>
        </div>
      </div>
            {/*-----------------Related products ----------------   */}
